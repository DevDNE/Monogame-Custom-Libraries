...
public class Game1 : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        _screen = new ScreenScaler(GraphicsDevice, _settingsManager.WindowWidth, _settingsManager.WindowHeight);
        ...
        playState.SetPauseState(new PauseState(_gameStateManager, _keyboardManager, _font, art, vw, vh));
